...
enum {
	...
	BINARY_IS_LIBC = 1 << 2,
	BINARY_IS_CRYPTO = 1 << 3,
	BINARY_IS_PTHREAD = 1 << 4,
	BINARY_IS_LIBSTDCPP = 1 << 5,
	BINARY_IS_SECCOMP = 1 << 6,
	BINARY_IS_LIBCAP = 1 << 7,
	BINARY_IS_LIBNSS_SYSTEMD = 1 << 8,
	BINARY_IS_LOADED_VIA_DLOPEN = 1 << 9,
	BINARY_IS_GOLANG = 1 << 10,
	BINARY_IS_LIBREADLINE = 1 << 11,
