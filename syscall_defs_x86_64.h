...
SYSCALL_DEF(shmget, SYSCALL_RETURNS_FD, SYSCALL_ARG_IS_INTEGER, SYSCALL_ARG_IS_INTEGER, SYSCALL_ARG_IS_SHM_FLAGS)
...
SYSCALL_DEF(mkdir, 0, SYSCALL_ARG_IS_PATH, SYSCALL_ARG_IS_MODE)
SYSCALL_DEF(rmdir, 0, SYSCALL_ARG_IS_PATH)
SYSCALL_DEF(creat, 0, SYSCALL_ARG_IS_PATH, SYSCALL_ARG_IS_MODE)
...
SYSCALL_DEF(chmod, 0, SYSCALL_ARG_IS_PATH, SYSCALL_ARG_IS_MODE)
...
SYSCALL_DEF(mknod, 0, SYSCALL_ARG_IS_PATH, SYSCALL_ARG_IS_MODE, SYSCALL_ARG_IS_INTEGER)
...
SYSCALL_DEF(fchmodat, 0, SYSCALL_ARG_IS_FD, SYSCALL_ARG_IS_PATH, SYSCALL_ARG_IS_FLAGS, SYSCALL_ARG_IS_ACCESSAT_FLAGS)
...
SYSCALL_DEF(faccessat2, 0, SYSCALL_ARG_IS_FD, SYSCALL_ARG_IS_PATH, SYSCALL_ARG_IS_INTEGER, SYSCALL_ARG_IS_ACCESSAT_FLAGS)
