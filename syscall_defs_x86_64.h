...
SYSCALL_DEF(open, SYSCALL_RETURNS_FD, SYSCALL_ARG_IS_PATH, SYSCALL_ARG_IS_OPEN_FLAGS, SYSCALL_ARG_IS_MODEFLAGS_OF(1))
...
SYSCALL_DEF(access, SYSCALL_RETURNS_ERROR, SYSCALL_ARG_IS_PATH, SYSCALL_ARG_IS_ACCESS_MODE)
...
SYSCALL_DEF(dup2, SYSCALL_RETURNS_FD, SYSCALL_ARG_IS_FD, SYSCALL_ARG_IS_FLAGS)
...
SYSCALL_DEF(timer_settime, 0, SYSCALL_ARG_IS_CLOCK_ID, SYSCALL_ARG_IS_FLAGS, SYSCALL_ARG_IS_ADDRESS, SYSCALL_ARG_IS_ADDRESS)
...
SYSCALL_DEF(clock_nanosleep, SYSCALL_IS_RESTARTABLE, SYSCALL_ARG_IS_CLOCK_ID, SYSCALL_ARG_IS_FLAGS, SYSCALL_ARG_IS_ADDRESS, SYSCALL_ARG_IS_ADDRESS)
...
SYSCALL_DEF(fchmodat, 0, SYSCALL_ARG_IS_FD, SYSCALL_ARG_IS_PATH, SYSCALL_ARG_IS_FLAGS, SYSCALL_ARG_IS_AT_FLAGS)
SYSCALL_DEF(faccessat, 0, SYSCALL_ARG_IS_FD, SYSCALL_ARG_IS_PATH, SYSCALL_ARG_IS_ACCESS_MODE, SYSCALL_ARG_IS_AT_FLAGS)
...
SYSCALL_DEF(utimensat, 0, SYSCALL_ARG_IS_FD, SYSCALL_ARG_IS_PATH, SYSCALL_ARG_IS_ADDRESS, SYSCALL_ARG_IS_AT_FLAGS)
...
SYSCALL_DEF(timerfd_create, 0, SYSCALL_ARG_IS_CLOCK_ID, SYSCALL_ARG_IS_FLAGS)
...
SYSCALL_DEF(name_to_handle_at, 0, SYSCALL_ARG_IS_FD, SYSCALL_ARG_IS_PATH, SYSCALL_ARG_IS_ADDRESS, SYSCALL_ARG_IS_ADDRESS, SYSCALL_ARG_IS_AT_FLAGS)
...
SYSCALL_DEF(renameat2, 0, SYSCALL_ARG_IS_FD, SYSCALL_ARG_IS_PATH, SYSCALL_ARG_IS_FD, SYSCALL_ARG_IS_PATH, SYSCALL_ARG_IS_AT_FLAGS)
...
SYSCALL_DEF(execveat, 0, SYSCALL_ARG_IS_FD, SYSCALL_ARG_IS_PATH, SYSCALL_ARG_IS_ADDRESS, SYSCALL_ARG_IS_ADDRESS, SYSCALL_ARG_IS_AT_FLAGS)
...
SYSCALL_DEF(faccessat2, 0, SYSCALL_ARG_IS_FD, SYSCALL_ARG_IS_PATH, SYSCALL_ARG_IS_INTEGER, SYSCALL_ARG_IS_AT_FLAGS)
