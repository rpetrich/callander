...
SYSCALL_DEF(open, 3, SYSCALL_ARG_IS_ADDRESS(0))
...
SYSCALL_DEF(openat, 4, 0)
SYSCALL_DEF(mkdirat, 3, 0)
SYSCALL_DEF(mknodat, 4, 0)
SYSCALL_DEF(fchownat, 5, 0)
SYSCALL_DEF(futimesat, 3, 0)
SYSCALL_DEF(newfstatat, 4, 0)
SYSCALL_DEF(unlinkat, 3, 0)
SYSCALL_DEF(renameat, 4, 0)
SYSCALL_DEF(linkat, 5, 0)
SYSCALL_DEF(symlinkat, 3, 0)
SYSCALL_DEF(readlinkat, 4, 0)
SYSCALL_DEF(fchmodat, 3, 0)
SYSCALL_DEF(faccessat, 3, 0)
SYSCALL_DEF(pselect6, 6, 0)
SYSCALL_DEF(ppoll, 5, 0)
SYSCALL_DEF(unshare, 1, 0)
SYSCALL_DEF(set_robust_list, 2, 0)
SYSCALL_DEF(get_robust_list, 3, 0)
SYSCALL_DEF(splice, 6, 0)
SYSCALL_DEF(tee, 4, 0)
SYSCALL_DEF(sync_file_range, 4, 0)
SYSCALL_DEF(vmsplice, 4, 0)
SYSCALL_DEF(move_pages, 6, 0)
SYSCALL_DEF(utimensat, 4, 0)
SYSCALL_DEF(epoll_pwait, 5, 0)
