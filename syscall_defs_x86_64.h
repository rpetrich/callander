...
SYSCALL_DEF(open, SYSCALL_RETURNS_FD, SYSCALL_ARG_IS_PATH, SYSCALL_ARG_IS_FLAGS, SYSCALL_ARG_IS_MODEFLAGS_OF(1))
SYSCALL_DEF(close, SYSCALL_RETURNS_ERROR, SYSCALL_ARG_IS_FD)
SYSCALL_DEF(stat, SYSCALL_RETURNS_ERROR, SYSCALL_ARG_IS_PATH, SYSCALL_ARG_IS_ADDRESS)
SYSCALL_DEF(fstat, SYSCALL_RETURNS_ERROR, SYSCALL_ARG_IS_FD, SYSCALL_ARG_IS_ADDRESS)
SYSCALL_DEF(lstat, SYSCALL_RETURNS_ERROR, SYSCALL_ARG_IS_PATH, SYSCALL_ARG_IS_ADDRESS)
SYSCALL_DEF(poll, SYSCALL_IS_RESTARTABLE | SYSCALL_RETURNS_COUNT, SYSCALL_ARG_IS_ADDRESS, SYSCALL_ARG_IS_COUNT_OF(0), SYSCALL_ARG_IS_INTEGER)
SYSCALL_DEF(lseek, SYSCALL_RETURNS_OFFSET, SYSCALL_ARG_IS_FD, SYSCALL_ARG_IS_OFFSET, SYSCALL_ARG_IS_INTEGER)
SYSCALL_DEF(mmap, SYSCALL_RETURNS_ADDRESS, SYSCALL_ARG_IS_ADDRESS, SYSCALL_ARG_IS_SIZE_OF(0), SYSCALL_ARG_IS_PROT, SYSCALL_ARG_IS_FLAGS, SYSCALL_ARG_IS_FD, SYSCALL_ARG_IS_OFFSET)
...
SYSCALL_DEF(rt_sigaction, SYSCALL_RETURNS_ERROR, SYSCALL_ARG_IS_INTEGER, SYSCALL_ARG_IS_ADDRESS, SYSCALL_ARG_IS_ADDRESS, SYSCALL_ARG_IS_SIZE_OF(1))
SYSCALL_DEF(rt_sigprocmask, SYSCALL_RETURNS_ERROR, SYSCALL_ARG_IS_INTEGER, SYSCALL_ARG_IS_ADDRESS, SYSCALL_ARG_IS_ADDRESS, SYSCALL_ARG_IS_SIZE_OF(1))
...
SYSCALL_DEF(access, SYSCALL_RETURNS_ERROR, SYSCALL_ARG_IS_PATH, SYSCALL_ARG_IS_FLAGS)
SYSCALL_DEF(pipe, SYSCALL_RETURNS_ERROR, SYSCALL_ARG_IS_ADDRESS)
SYSCALL_DEF(select, SYSCALL_RETURNS_COUNT, SYSCALL_ARG_IS_INTEGER, SYSCALL_ARG_IS_ADDRESS, SYSCALL_ARG_IS_ADDRESS, SYSCALL_ARG_IS_ADDRESS, SYSCALL_ARG_IS_ADDRESS)
SYSCALL_DEF(sched_yield, SYSCALL_RETURNS_ERROR)
SYSCALL_DEF(mremap, SYSCALL_RETURNS_ADDRESS, SYSCALL_ARG_IS_ADDRESS, SYSCALL_ARG_IS_SIZE_OF(0), SYSCALL_ARG_IS_INTEGER, SYSCALL_ARG_IS_FLAGS, SYSCALL_ARG_IS_ADDRESS)
SYSCALL_DEF(msync, SYSCALL_RETURNS_ERROR, SYSCALL_ARG_IS_ADDRESS, SYSCALL_ARG_IS_SIZE_OF(0), SYSCALL_ARG_IS_FLAGS)
SYSCALL_DEF(mincore, SYSCALL_RETURNS_ERROR, SYSCALL_ARG_IS_ADDRESS, SYSCALL_ARG_IS_COUNT_OF(2), SYSCALL_ARG_IS_ADDRESS)
SYSCALL_DEF(madvise, SYSCALL_RETURNS_ERROR, SYSCALL_ARG_IS_ADDRESS, SYSCALL_ARG_IS_SIZE_OF(1), SYSCALL_ARG_IS_INTEGER)
SYSCALL_DEF(shmget, SYSCALL_RETURNS_FD, SYSCALL_ARG_IS_INTEGER, SYSCALL_ARG_IS_INTEGER, SYSCALL_ARG_IS_FLAGS)
SYSCALL_DEF(shmat, SYSCALL_RETURNS_ADDRESS, SYSCALL_ARG_IS_INTEGER, SYSCALL_ARG_IS_ADDRESS, SYSCALL_ARG_IS_FLAGS)
...
SYSCALL_DEF(dup2, SYSCALL_RETURNS_FD, SYSCALL_ARG_IS_FD, SYSCALL_ARG_IS_FD)
SYSCALL_DEF(pause, SYSCALL_RETURNS_ERROR)
SYSCALL_DEF(nanosleep, SYSCALL_IS_RESTARTABLE | SYSCALL_RETURNS_ERROR, SYSCALL_ARG_IS_ADDRESS, SYSCALL_ARG_IS_ADDRESS)
SYSCALL_DEF(getitimer, SYSCALL_RETURNS_ERROR, SYSCALL_ARG_IS_INTEGER, SYSCALL_ARG_IS_ADDRESS)
SYSCALL_DEF(alarm, 0, SYSCALL_ARG_IS_INTEGER)
SYSCALL_DEF(setitimer, SYSCALL_RETURNS_ERROR, SYSCALL_ARG_IS_INTEGER, SYSCALL_ARG_IS_ADDRESS, SYSCALL_ARG_IS_ADDRESS)
...
SYSCALL_DEF(socket, SYSCALL_RETURNS_FD, SYSCALL_ARG_IS_INTEGER, SYSCALL_ARG_IS_INTEGER, SYSCALL_ARG_IS_INTEGER)
...
SYSCALL_DEF(sendto, SYSCALL_RETURNS_SIZE, SYSCALL_ARG_IS_FD, SYSCALL_ARG_IS_ADDRESS, SYSCALL_ARG_IS_SIZE_OF(1), SYSCALL_ARG_IS_FLAGS, SYSCALL_ARG_IS_ADDRESS, SYSCALL_ARG_IS_SIZE_OF(4))
SYSCALL_DEF(recvfrom, SYSCALL_RETURNS_SIZE, SYSCALL_ARG_IS_FD, SYSCALL_ARG_IS_ADDRESS, SYSCALL_ARG_IS_SIZE_OF(1), SYSCALL_ARG_IS_FLAGS, SYSCALL_ARG_IS_ADDRESS, SYSCALL_ARG_IS_ADDRESS)
SYSCALL_DEF(sendmsg, SYSCALL_RETURNS_SIZE, SYSCALL_ARG_IS_FD, SYSCALL_ARG_IS_ADDRESS, SYSCALL_ARG_IS_FLAGS)
SYSCALL_DEF(recvmsg, SYSCALL_RETURNS_SIZE, SYSCALL_ARG_IS_FD, SYSCALL_ARG_IS_ADDRESS, SYSCALL_ARG_IS_FLAGS)
SYSCALL_DEF(shutdown, SYSCALL_RETURNS_ERROR, SYSCALL_ARG_IS_FD, SYSCALL_ARG_IS_INTEGER)
