...
#endif
	intptr_t result;
	asm __volatile__(FS_CALL_SYSCALL : "=a"(result) : "a"(id) : "memory", "cc", "rcx", "r11");
	return result;
}
...
#endif
	intptr_t result;
	asm __volatile__(FS_CALL_SYSCALL : "=a"(result) : "a"(id), "D"(arg1) : "memory", "cc", "rcx", "r11");
	return result;
}
...
__attribute__((always_inline)) noreturn static inline void fs_syscall_noreturn1(intptr_t id, intptr_t arg1)
{
	...
	id |= 2 << 24;
#endif
	asm __volatile__(FS_JUMP_SYSCALL : : "a"(id), "D"(arg1) : "memory");
...
#endif
	intptr_t result;
	asm __volatile__(FS_CALL_SYSCALL : "=a"(result) : "a"(id), "D"(arg1), "S"(arg2) : "memory", "cc", "rcx", "r11");
	return result;
}
...
#endif
	intptr_t result;
	asm __volatile__(FS_CALL_SYSCALL : "=a"(result) : "a"(id), "D"(arg1), "S"(arg2), "d"(arg3) : "memory", "cc", "rcx", "r11");
	return result;
}
...
__attribute__((always_inline)) static inline intptr_t fs_syscall4(intptr_t id, intptr_t arg1, intptr_t arg2, intptr_t arg3, intptr_t arg4)
{
	...
	asm __volatile__(FS_CALL_SYSCALL : "=a"(result) : "a"(id), "D"(arg1), "S"(arg2), "d"(arg3), "r"(r10) : "memory", "cc", "rcx", "r11");
	return result;
}
...
__attribute__((always_inline)) static inline intptr_t fs_syscall5(intptr_t id, intptr_t arg1, intptr_t arg2, intptr_t arg3, intptr_t arg4, intptr_t arg5)
{
	...
	asm __volatile__(FS_CALL_SYSCALL : "=a"(result) : "a"(id), "D"(arg1), "S"(arg2), "d"(arg3), "r"(r10), "r"(r8) : "memory", "cc", "rcx", "r11");
	return result;
}
...
__attribute__((always_inline)) static inline intptr_t fs_syscall6(intptr_t id, intptr_t arg1, intptr_t arg2, intptr_t arg3, intptr_t arg4, intptr_t arg5, intptr_t arg6)
{
	...
	asm __volatile__(FS_CALL_SYSCALL : "=a"(result) : "a"(id), "D"(arg1), "S"(arg2), "d"(arg3), "r"(r10), "r"(r8), "r"(r9) : "memory", "cc", "rcx", "r11");
	return result;
}
