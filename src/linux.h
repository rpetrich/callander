...
#define LINUX_AT_EACCESS		0x200	/* Test access permitted for
                                           effective IDs, not real IDs.  */
#define LINUX_AT_REMOVEDIR		0x200   /* Remove directory instead of
                                           unlinking file.  */
...
#define LINUX_AT_HANDLE_FID		LINUX_AT_REMOVEDIR	/* file handle is needed to
...
#define LINUX_MAP_UNINITIALIZED 0x4000000	/* For anonymous mmap, memory could be
					 * uninitialized */
