...
__attribute__((warn_unused_result)) static inline intptr_t read_thread_id(void)
{
#if defined(__x86_64__)
...
__attribute__((warn_unused_result)) static inline struct thread_data *preferred_thread_slot(intptr_t thread_id)
{
