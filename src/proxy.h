...
__attribute__((always_inline)) static inline proxy_arg proxy_value(intptr_t value)
{
	return (proxy_arg){
		.value = value,
		.size = 0,
...
__attribute__((always_inline)) static inline proxy_arg proxy_in(const void *address, size_t size)
{
	return (proxy_arg){
...
__attribute__((always_inline)) static inline proxy_arg proxy_string(const char *address)
{
	if (address == NULL) {
		return (proxy_arg){
			.value = 0,
...
__attribute__((always_inline)) static inline proxy_arg proxy_wide_string(const uint16_t *address)
{
	if (address == NULL) {
		return (proxy_arg){
			.value = 0,
...
__attribute__((always_inline)) static inline proxy_arg proxy_out(void *address, size_t size)
{
	return (proxy_arg){
		.value = (intptr_t)address,
...
__attribute__((always_inline)) static inline proxy_arg proxy_inout(void *address, size_t size)
{
	return (proxy_arg){
		.value = (intptr_t)address,
...
__attribute__((always_inline)) static inline int proxy_fill_request_message(request_message *request, struct iovec iov[PROXY_ARGUMENT_COUNT], int syscall, proxy_arg args[PROXY_ARGUMENT_COUNT])
{
...
#else
__attribute__((always_inline)) static inline enum target_platform proxy_get_target_platform(void)
{
...
#define PROXY_ARGS(...)                                                                                                                                                                                                         \
	(proxy_arg[PROXY_ARGUMENT_COUNT])                                                                                                                                                                                           \
	{                                                                                                                                                                                                                           \
		PROXY_ARGS_(0, 0, 0, 0, 0, ##__VA_ARGS__, proxy_value(0)), PROXY_ARGS_(0, 0, 0, 0, ##__VA_ARGS__, proxy_value(0), proxy_value(0)), PROXY_ARGS_(0, 0, 0, ##__VA_ARGS__, proxy_value(0), proxy_value(0), proxy_value(0)), \
			PROXY_ARGS_(0, 0, ##__VA_ARGS__, proxy_value(0), proxy_value(0), proxy_value(0), proxy_value(0)), PROXY_ARGS_(0, ##__VA_ARGS__, proxy_value(0), proxy_value(0), proxy_value(0), proxy_value(0), proxy_value(0)),    \
...
__attribute__((warn_unused_result)) ssize_t proxy_peek_string(intptr_t addr, size_t buffer_size, void *out_buffer);
