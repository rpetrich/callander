...
enum
{
	...
	SYSCALL_RETURNS_VALUE = 0x100,
	SYSCALL_RETURNS_SIZE = SYSCALL_RETURNS_VALUE,
	SYSCALL_RETURNS_COUNT = SYSCALL_RETURNS_VALUE,
	SYSCALL_RETURNS_OFFSET = SYSCALL_RETURNS_VALUE,
	SYSCALL_RETURNS_PID = SYSCALL_RETURNS_VALUE,
	...
	SYSCALL_RETURNS_ALWAYS_VALID = 0x700,
	...
	SYSCALL_ARG_IS_PATH = 0x4d,
	SYSCALL_ARG_IS_STRING = 0x4d,
	...
	SYSCALL_ARG_IS_FCNTL_ARG = 0x4e,
	SYSCALL_ARG_IS_SIGSET = 0x4f,
	SYSCALL_ARG_IS_PRCTL_ARG = 0x50,
	SYSCALL_ARG_IS_ROBUST_LIST = 0x51,
	SYSCALL_ARG_IS_KEYCTL_OP = 0x52,
	SYSCALL_ARG_IS_CLONE_ARGS = 0x53,
	SYSCALL_ARG_IS_BPF_ATTR = 0x54,
	SYSCALL_ARG_IS_RSEQ_SIG = 0x55,
	SYSCALL_ARG_IS_PERSONALITY = 0x56,
	SYSCALL_ARG_IS_PTRACE_ARG = 0x57,
	SYSCALL_ARG_IS_SYSLOG_ACTION = 0x58,
...
enum
{
	...
	BINARY_IS_LIBCRYPTO = 1 << 3,
	BINARY_IS_SECCOMP = 1 << 4,
	BINARY_IS_LIBCAP = 1 << 5,
	BINARY_IS_LIBNSS_SYSTEMD = 1 << 6,
	BINARY_IS_RUBY = 1 << 7,
	BINARY_IS_LIBPYTHON = 1 << 8,
	BINARY_IS_PERL = 1 << 9,
	BINARY_IS_LIBP11KIT = 1 << 10,
	BINARY_IS_LIBKRB5 = 1 << 11,
	BINARY_IS_LIBSASL2 = 1 << 12,

	BINARY_IS_LOADED_VIA_DLOPEN = 1 << 13,
	BINARY_IS_GOLANG = 1 << 14,

	BINARY_HAS_FUNCTION_SYMBOLS_ANALYZED = 1 << 16,
