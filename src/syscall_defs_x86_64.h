...
SYSCALL_DEF(setpgid, SYSCALL_RETURNS_ALWAYS_VALID, SYSCALL_ARG_IS_PID, SYSCALL_ARG_IS_INTEGER)
SYSCALL_DEF(getppid, SYSCALL_RETURNS_ALWAYS_VALID)
SYSCALL_DEF(getpgrp, SYSCALL_RETURNS_ALWAYS_VALID)
...
SYSCALL_DEF(getsid, SYSCALL_RETURNS_ALWAYS_VALID, SYSCALL_ARG_IS_PID)
...
SYSCALL_DEF(fchmodat, 0, SYSCALL_ARG_IS_FD, SYSCALL_ARG_IS_PATH, SYSCALL_ARG_IS_MODE)
SYSCALL_DEF(faccessat, 0, SYSCALL_ARG_IS_FD, SYSCALL_ARG_IS_PATH, SYSCALL_ARG_IS_ACCESS_MODE)
...
SYSCALL_DEF(io_pgetevents, 0, SYSCALL_ARG_IS_INTEGER, SYSCALL_ARG_IS_INTEGER, SYSCALL_ARG_IS_COUNT_OF(3), SYSCALL_ARG_IS_ADDRESS, SYSCALL_ARG_IS_ADDRESS, SYSCALL_ARG_IS_ADDRESS)
