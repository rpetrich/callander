...
#define FS_SYSCALL_NORETURN(id, ...)                                                                                                                                                                                 \
	do {                                                                                                                                                                                                             \
		FS_SYSCALL_(id, ##__VA_ARGS__, fs_syscall_noreturn6, fs_syscall_noreturn5, fs_syscall_noreturn4, fs_syscall_noreturn3, fs_syscall_noreturn2, fs_syscall_noreturn1, fs_syscall_noreturn0)(id, ##__VA_ARGS__); \
...
#ifdef __APPLE__
#define FS_HIDDEN_FUNCTION_ASM(name)         \
	".global " FS_NAME_ASM(name)             \
		"\n"                                 \
...
__attribute__((warn_unused_result)) static inline pid_t fs_fork(void)
{
#ifdef SYS_fork
...
__attribute__((warn_unused_result)) static inline intptr_t fs_write_all(int fd, const char *buffer, size_t length)
{
...
__attribute__((warn_unused_result)) static inline intptr_t fs_writev(int fd, const struct iovec *iov, int iovcnt)
{
	if (iovcnt == 1) {
...
__attribute__((warn_unused_result)) static inline intptr_t fs_writev_all(int fd, struct iovec *iov, int iovcnt)
{
...
__attribute__((warn_unused_result)) static inline intptr_t fs_read(int fd, char *buffer, size_t length)
{
	return FS_SYSCALL(SYS_read, fd, (intptr_t)buffer, (intptr_t)length);
}

__attribute__((warn_unused_result)) static inline intptr_t fs_read_all(int fd, char *buffer, size_t length)
{
	size_t remaining = length;
	while (remaining != 0) {
...
__attribute__((warn_unused_result)) static inline intptr_t fs_readv(int fd, const struct iovec *iov, int iovcnt)
{
	return FS_SYSCALL(SYS_readv, fd, (intptr_t)iov, (intptr_t)iovcnt);
}

__attribute__((warn_unused_result)) static inline intptr_t fs_readv_all(int fd, struct iovec *iov, int iovcnt)
{
...
__attribute__((warn_unused_result)) static inline intptr_t fs_recv(int fd, char *buffer, size_t length, int flags)
{
	return FS_SYSCALL(SYS_read, fd, (intptr_t)buffer, (intptr_t)length, flags);
}

__attribute__((warn_unused_result)) static inline intptr_t fs_recvmsg(int fd, struct msghdr *msg, int flags)
{
	return FS_SYSCALL(SYS_recvmsg, fd, (intptr_t)msg, flags);
}

__attribute__((warn_unused_result)) static inline intptr_t fs_pwrite(int fd, const char *buffer, size_t length, uint64_t offset)
{
#ifdef SYS_pwrite64
#ifdef __LP64__
...
__attribute__((warn_unused_result)) static inline intptr_t fs_pread(int fd, char *buffer, size_t length, uint64_t offset)
{
#ifdef SYS_pread64
#ifdef __LP64__
...
__attribute__((warn_unused_result)) static inline intptr_t fs_pread_all(int fd, char *buffer, size_t length, uint64_t offset)
{
	size_t remaining = length;
	while (remaining != 0) {
...
__attribute__((warn_unused_result)) static inline intptr_t fs_lseek(int fd, off_t offset, int origin)
{
	return FS_SYSCALL(SYS_lseek, fd, (intptr_t)offset, (intptr_t)origin);
}

__attribute__((warn_unused_result)) static inline int fs_pipe(int pipefd[2])
{
#ifdef SYS_pipe
...
__attribute__((warn_unused_result)) static inline int fs_socket(int domain, int type, int protocol)
{
	return (int)FS_SYSCALL(SYS_socket, domain, type, protocol);
}

__attribute__((warn_unused_result)) static inline int fs_socketpair(int domain, int type, int protocol, int sv[2])
{
	return (int)FS_SYSCALL(SYS_socketpair, domain, type, protocol, (intptr_t)sv);
}

__attribute__((warn_unused_result)) static inline int fs_setsockopt(int socket, int level, int option, const void *value, size_t value_len)
{
	return (int)FS_SYSCALL(SYS_setsockopt, socket, level, option, (intptr_t)value, (intptr_t)value_len);
}

__attribute__((warn_unused_result)) static inline int fs_getsockopt(int socket, int level, int option, void *value, size_t *value_len)
{
	return (int)FS_SYSCALL(SYS_getsockopt, socket, level, option, (intptr_t)value, (intptr_t)value_len);
}

__attribute__((warn_unused_result)) static inline int fs_connect(int socket, const void *address, size_t address_len)
{
	return (int)FS_SYSCALL(SYS_connect, socket, (intptr_t)address, (intptr_t)address_len);
}

__attribute__((warn_unused_result)) static inline int fs_bind(int socket, const void *address, size_t address_len)
{
	return (int)FS_SYSCALL(SYS_bind, socket, (intptr_t)address, (intptr_t)address_len);
}

__attribute__((warn_unused_result)) static inline int fs_listen(int socket, int backlog)
{
	return (int)FS_SYSCALL(SYS_listen, socket, (intptr_t)backlog);
}

__attribute__((warn_unused_result)) static inline int fs_accept(int socket, void *address, size_t *address_len)
{
	return (int)FS_SYSCALL(SYS_accept, socket, (intptr_t)address, (intptr_t)address_len);
}

__attribute__((warn_unused_result)) static inline int fs_open(const char *path, int flags, mode_t mode)
{
#ifdef SYS_open
...
__attribute__((warn_unused_result)) static inline int fs_openat(int fd, const char *path, int flags, mode_t mode)
{
	return (int)FS_SYSCALL(SYS_openat, fd, (intptr_t)path, flags, mode);
}

__attribute__((warn_unused_result)) static inline int fs_mkdir(const char *path, mode_t mode)
{
#ifdef SYS_mkdir
...
__attribute__((warn_unused_result)) static inline int fs_mkdirat(int dirfd, const char *path, mode_t mode)
{
	return (int)FS_SYSCALL(SYS_mkdirat, dirfd, (intptr_t)path, mode);
}

__attribute__((warn_unused_result)) static inline int fs_readlink(const char *path, char *buf, size_t bufsiz)
{
#ifdef SYS_readlink
...
__attribute__((warn_unused_result)) static inline int fs_readlinkat(int fd, const char *path, char *buf, size_t bufsiz)
{
	return (int)FS_SYSCALL(SYS_readlinkat, fd, (intptr_t)path, (intptr_t)buf, (intptr_t)bufsiz);
}

__attribute__((warn_unused_result)) static inline int fs_unlink(const char *path)
{
#ifdef SYS_unlink
...
__attribute__((warn_unused_result)) static inline int fs_unlinkat(int fd, const char *path, int flags)
{
	return (int)FS_SYSCALL(SYS_unlinkat, fd, (intptr_t)path, flags);
}

__attribute__((warn_unused_result)) static inline int fs_renameat(int old_dirfd, const char *old_path, int new_dirfd, const char *new_path)
{
	return (int)FS_SYSCALL(SYS_renameat, old_dirfd, (intptr_t)old_path, new_dirfd, (intptr_t)new_path);
}

#ifdef SYS_renameat2
__attribute__((warn_unused_result)) static inline int fs_renameat2(int old_dirfd, const char *old_path, int new_dirfd, const char *new_path, int flags)
{
	return (int)FS_SYSCALL(SYS_renameat2, old_dirfd, (intptr_t)old_path, new_dirfd, (intptr_t)new_path, flags);
}
#endif

__attribute__((warn_unused_result)) static inline int fs_linkat(int old_dirfd, const char *old_path, int new_dirfd, const char *new_path, int flags)
{
	return (int)FS_SYSCALL(SYS_linkat, old_dirfd, (intptr_t)old_path, new_dirfd, (intptr_t)new_path, flags);
}

__attribute__((warn_unused_result)) static inline int fs_symlinkat(const char *old_path, int new_dirfd, const char *new_path)
{
	return (int)FS_SYSCALL(SYS_symlinkat, (intptr_t)old_path, new_dirfd, (intptr_t)new_path);
}

__attribute__((warn_unused_result)) static inline int fs_fchmod(int fd, mode_t mode)
{
	return (int)FS_SYSCALL(SYS_fchmod, fd, mode);
}

__attribute__((warn_unused_result)) static inline int fs_fchmodat(int dirfd, const char *path, mode_t mode, int flags)
{
	return (int)FS_SYSCALL(SYS_fchmodat, dirfd, (intptr_t)path, mode, flags);
}

__attribute__((warn_unused_result)) static inline int fs_fchown(int fd, uid_t uid, gid_t gid)
{
	return (int)FS_SYSCALL(SYS_fchown, fd, uid, gid);
}

__attribute__((warn_unused_result)) static inline int fs_fchownat(int fd, const char *path, uid_t uid, gid_t gid, int flags)
{
	return (int)FS_SYSCALL(SYS_fchownat, fd, (intptr_t)path, uid, gid, flags);
}

__attribute__((warn_unused_result)) static inline int fs_ftruncate(int fd, size_t size)
{
	return (int)FS_SYSCALL(SYS_ftruncate, fd, (intptr_t)size);
}

__attribute__((warn_unused_result)) static inline int fs_fstat(int fd, struct fs_stat *buf)
{
#ifdef SYS_fstat64
...
__attribute__((warn_unused_result)) static inline int fs_stat(const char *path, struct fs_stat *buf)
{
#ifdef SYS_stat64
...
__attribute__((warn_unused_result)) static inline int fs_fstatfs(int fd, struct fs_statfs *buf)
{
#ifdef SYS_fstatfs64
...
__attribute__((warn_unused_result)) static inline int fs_faccessat(int dirfd, const char *pathname, int mode, int flags)
{
#ifdef __linux__
	if (flags == 0) {
...
__attribute__((warn_unused_result)) static inline int fs_access(const char *pathname, int mode)
{
#ifdef SYS_access
...
__attribute__((warn_unused_result)) static inline int fs_dup(int oldfd)
{
	return (int)FS_SYSCALL(SYS_dup, oldfd);
}

__attribute__((warn_unused_result)) static inline int fs_dup2(int oldfd, int newfd)
{
#ifdef SYS_dup2
...
#ifdef SYS_dup3
__attribute__((warn_unused_result)) static inline int fs_dup3(int oldfd, int newfd, int flags)
{
	return (int)FS_SYSCALL(SYS_dup3, oldfd, newfd, flags);
}
#endif

__attribute__((warn_unused_result)) static inline int fs_fcntl(int fd, int cmd, uintptr_t arg)
{
...
__attribute__((warn_unused_result)) static inline ssize_t fs_getcwd(char *buf, size_t size)
{
#ifdef SYS_getcwd
...
__attribute__((warn_unused_result)) static inline intptr_t fs_chdir(const char *path)
{
...
__attribute__((warn_unused_result)) static inline intptr_t fs_fchdir(int fd)
{
...
__attribute__((warn_unused_result)) static inline void *fs_mmap(void *addr, size_t length, int prot, int flags, int fd, off_t offset)
{
	return (void *)FS_SYSCALL(SYS_mmap, (intptr_t)addr, (intptr_t)length, prot, flags, fd, offset);
}

__attribute__((warn_unused_result)) static inline bool fs_is_map_failed(void *address)
{
...
#ifdef SYS_mremap
__attribute__((warn_unused_result)) static inline void *fs_mremap(void *old_address, size_t old_size, size_t new_size, int flags, void *new_address)
{
	return (void *)FS_SYSCALL(SYS_mremap, (intptr_t)old_address, (intptr_t)old_size, (intptr_t)new_size, flags, (intptr_t)new_address);
}
#endif

__attribute__((warn_unused_result)) static inline int fs_mprotect(void *addr, size_t len, int prot)
{
	return (int)FS_SYSCALL(SYS_mprotect, (intptr_t)addr, (intptr_t)len, prot);
}

__attribute__((warn_unused_result)) static inline int fs_mincore(const void *addr, size_t length, unsigned char *vec)
{
	return (int)FS_SYSCALL(SYS_mincore, (intptr_t)addr, (intptr_t)length, (intptr_t)vec);
}

#ifdef SYS_prctl
__attribute__((warn_unused_result)) static inline int fs_prctl(int option, unsigned long arg2, unsigned long arg3, unsigned long arg4, unsigned long arg5)
{
...
#ifdef SYS_seccomp
__attribute__((warn_unused_result)) static inline int fs_seccomp(unsigned int operation, unsigned int flags, void *args)
{
...
__attribute__((warn_unused_result)) static inline int fs_sigaction(int signum, const struct fs_sigaction *act, struct fs_sigaction *oldact)
{
...
#ifdef SYS_rt_sigaction
__attribute__((warn_unused_result)) static inline int fs_rt_sigaction(int signum, const struct fs_sigaction *act, struct fs_sigaction *oldact, size_t sigsetsize)
{
...
__attribute__((warn_unused_result)) static inline int fs_sigprocmask(int how, const struct fs_sigset_t *set, struct fs_sigset_t *oldset, size_t sigsetsize)
{
...
__attribute__((warn_unused_result)) static inline int fs_rt_sigprocmask(int how, const struct fs_sigset_t *set, struct fs_sigset_t *oldset, size_t sigsetsize)
{
...
__attribute__((warn_unused_result)) static inline int fs_sigaltstack(const stack_t *ss, stack_t *old_ss)
{
	return (int)FS_SYSCALL(SYS_sigaltstack, (intptr_t)ss, (intptr_t)old_ss);
}

__attribute__((warn_unused_result)) static inline pid_t fs_getpid(void)
{
	return (pid_t)FS_SYSCALL(SYS_getpid);
}

__attribute__((warn_unused_result)) static inline pid_t fs_getpgid(pid_t pid)
{
	return (pid_t)FS_SYSCALL(SYS_getpgid, pid);
}

__attribute__((warn_unused_result)) static inline pid_t fs_gettid(void)
{
...
__attribute__((warn_unused_result)) static inline uid_t fs_getuid(void)
{
	return (uid_t)FS_SYSCALL(SYS_getuid);
}

__attribute__((warn_unused_result)) static inline gid_t fs_getgid(void)
{
	return (gid_t)FS_SYSCALL(SYS_getgid);
}

#ifdef SYS_tkill
__attribute__((warn_unused_result)) static inline int fs_tkill(int tid, int sig)
{
	return (int)FS_SYSCALL(SYS_tkill, tid, sig);
}
#endif

__attribute__((warn_unused_result)) static inline int fs_kill(int pid, int sig)
{
	return (int)FS_SYSCALL(SYS_kill, pid, sig);
}

__attribute__((warn_unused_result)) static inline int fs_execve(const char *pathname, char *const argv[], char *const envp[])
{
	return (int)FS_SYSCALL(SYS_execve, (intptr_t)pathname, (intptr_t)argv, (intptr_t)envp);
}

#ifdef SYS_execveat
__attribute__((warn_unused_result)) static inline int fs_execveat(int dirfd, const char *pathname, char *const argv[], char *const envp[], int flags)
{
...
__attribute__((warn_unused_result)) __attribute__((nonnull(1))) static inline const char *fs_strstr(const char *haystack, const char *needle)
{
	for (;; haystack++) {
		for (int i = 0;; i++) {
			if (needle[i] == '\0') {
...
__attribute__((warn_unused_result)) __attribute__((nonnull(1, 2))) static inline const char *fs_strpbrk(const char *str, const char *characters)
{
	for (;;) {
		char c = *str;
...
__attribute__((nonnull(1))) static inline void fs_reverse(char buffer[], size_t length)
{
...
__attribute__((nonnull(2))) static inline size_t fs_utoa(uintptr_t value, char buffer[])
{
	size_t i = 0;
	do {
...
__attribute__((nonnull(2))) static inline size_t fs_itoa(intptr_t value, char buffer[])
{
	if (value < 0) {
		*buffer = '-';
...
__attribute__((nonnull(2))) static inline size_t fs_utoah_noprefix(uintptr_t value, char buffer[])
{
	size_t i = 0;
	do {
...
// enough space for the largest formatted number to be written
__attribute__((nonnull(2))) static inline size_t fs_utoah(uintptr_t value, char buffer[])
{
	buffer[0] = '0';
	buffer[1] = 'x';
	size_t i = 2;
...
__attribute__((warn_unused_result)) static inline int fs_hexval(char value)
{
	if (value >= '0' && value <= '9') {
		return value - '0';
	}
...
__attribute__((warn_unused_result)) __attribute__((nonnull(1, 2))) static inline const char *fs_scanu(const char *buffer, uintptr_t *result)
{
...
__attribute__((warn_unused_result)) __attribute__((nonnull(1, 2))) static inline const char *fs_scans(const char *buffer, intptr_t *result)
{
...
__attribute__((warn_unused_result)) __attribute__((nonnull(2))) static inline int fs_readlink_fd(int fd, char *out_path, size_t size)
{
	if (fd < 0) {
		return -EINVAL;
	}
...
__attribute__((warn_unused_result)) __attribute__((nonnull(2))) static inline int fs_fd_getpath(int fd, char out_path[PATH_MAX])
{
#ifdef __linux__
...
__attribute__((warn_unused_result)) __attribute__((nonnull(1))) static inline int fs_cmpxchg(atomic_int *state, int expected, int desired)
{
...
#endif
static inline void
fs_mutex_lock_slow_path(struct fs_mutex *mutex, int state)
{
	do {
...
__attribute__((always_inline)) __attribute__((nonnull(1))) static inline void fs_mutex_lock(struct fs_mutex *mutex)
{
...
#endif
static inline void
fs_mutex_unlock_slow_path(struct fs_mutex *mutex)
{
...
__attribute__((always_inline)) __attribute__((nonnull(1))) static inline void fs_mutex_unlock(struct fs_mutex *mutex)
{
...
__attribute__((always_inline)) static inline bool fs_is_eintr(int err)
{
#ifdef EINTR
	return err == -EINTR;
#else
