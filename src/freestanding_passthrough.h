...
__attribute__((always_inline)) static inline intptr_t fs_adapt_socket_result(intptr_t result)
{
...
__attribute__((warn_unused_result)) static inline intptr_t fs_recv(int socket, char *buffer, size_t length, int flags)
{
