...
__attribute__((visibility("default"))) noreturn void receive_start(const struct receive_start_args *args);

__attribute__((used)) __attribute__((visibility("default"))) void receive_clone(intptr_t data[7]);

__attribute__((visibility("default"))) void receive_syscall(intptr_t data[7]);
